        ...
        <div className="bg-[#eee] shadow-lg py-10 px-2 sm:px-0 ">
            <div className="container lg:px-[2rem] space-y-5">
                ...
                <div className="max-w-screen-lg mx-auto grid gap-2 md:gap-5 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                    {
                        lists.map(list => (
                            ...
                            md:py-0 md:px-0 px-1 py-2 shadow-xl">
                                <div className="w-[200px] h-[120px] md:w-full md:h-[170px] relative">
                                    <Image src="/img/jesus.jpg"
                                        ...
                                        placeholder="blur"
                                        alt="logo" />
                                    <div className=" hidden md:block uppercase text-sm absolute py-1 px-4 top-3 left-3 text-[white]/80 bg-primary-black/70">
                                        Sermon
                                    </div>
                                </div>
                ...
                bg-primary-light text-[white] cursor-pointer ">
                    <h1 className="uppercase text-base md:text-lg">See All</h1>
                </div>
            </div>
        </div>
    )
