...
const Menu = ({ menuState }) => {
    ...
    return (
        <div className={`${menuState ? " w-[70%] md:w-[40%] " : "w-0"} !shadow-2xl lg:hidden py-5 fixed transition-all duration-700 ease-in-out bg-[white] h-screen top-0 right-0 !z-50 !overflow-x-hidden `}>
